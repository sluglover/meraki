#!/usr/bin/env python3
"""
THIS EXPLICITLY REQUIRES THAT YOU RUN rundatabase2.sh IN SCRIPTS DIRECTORY BEFORE YOU RUN THIS. 
REWORKING WOULD BE A PAIN WHERE I WOULD HAVE TO DO A LOT OF RESTRUCTURING (DEALING WITH SUPERIOR HARDWOODS)
